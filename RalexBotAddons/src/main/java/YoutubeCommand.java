...
public class YoutubeCommand extends Listener {
    ...
    public void runEvent(CommandEvent event) {
        ...
        if (args.length
                == 0 || total.isEmpty()) {
            Utils.sendMessage(target, "http://www.youtube.com");
            return;
        }


        try {
            String url = "http://ajax.googleapis.com/ajax/services/search/web?v=1.0&q=site:http://www.youtube.com%20" + total.replace(" ", "%20");
