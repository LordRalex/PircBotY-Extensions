...
public class BotUser extends User {
    ...
    public void kick(org.hoenn.pokebot.api.channels.Channel chan, User user) {
    ...
    public void ban(org.hoenn.pokebot.api.channels.Channel chan, User user) {
    ...
    public void op(org.hoenn.pokebot.api.channels.Channel chan, org.hoenn.pokebot.api.users.User user) {
    ...
    public void deop(org.hoenn.pokebot.api.channels.Channel chan, org.hoenn.pokebot.api.users.User user) {
    ...
    public void voice(org.hoenn.pokebot.api.channels.Channel chan, org.hoenn.pokebot.api.users.User user) {
    ...
    public void devoice(org.hoenn.pokebot.api.channels.Channel chan, org.hoenn.pokebot.api.users.User user) {
